...
# Assuming df_prediction is ready and includes your target variable and features

# Example: Predicting magnitude
X = df_prediction[['Latitude', 'Longitude', 'Depth']]  # Features
y = df_prediction['Magnitude']  # Target variable
